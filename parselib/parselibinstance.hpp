...
public :
	 ...
	 */
	parsetree::AbsNode* process_source (std::string filename, bool verbose=false, size_t index=0) ;
...
private :
	 ...
	 */
	parsetree::AbsNode* parse (parsetree::AbsNode* code=new parsetree::Tree(), std::string parent="") ;
