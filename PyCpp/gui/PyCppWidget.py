...
class Ui_pyCppGui(object):
    ...
    def retranslateUi(self, pyCppGui):
        ...
        self.globex_lineEdit.setText(_translate("pyCppGui", "*.cpy"))
        ...
        self.cppver_comboBox.setCurrentText(_translate("pyCppGui", "03"))
        self.cppver_comboBox.setItemText(0, _translate("pyCppGui", "03"))
        self.cppver_comboBox.setItemText(1, _translate("pyCppGui", "11"))
        self.cppver_comboBox.setItemText(2, _translate("pyCppGui", "14"))
        self.cppver_comboBox.setItemText(3, _translate("pyCppGui", "17"))
        self.cppver_comboBox.setItemText(4, _translate("pyCppGui", "20"))
